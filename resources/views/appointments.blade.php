...
#content main .table-data .order table tr td .status.add {
	background:rgb(56, 56, 190);
	cursor:pointer;
}
#content main .table-data .order table tr td .status.modify{
	background:rgb(59, 199, 133);
	cursor:pointer;
}
    ...
    <section id="sidebar">
        ...
        <ul class="side-menu top">
            ...
            <li>
                    ...
                    <span class="text">Appointment Records</span>
                </a>
            </li>
        </ul>
        <ul class="side-menu">
                                    ...
                                    <td>
                                        @if ($appointment->status === 'pending')
                                            <form action="{{ route('appointments.approve', $appointment->id) }}" method="post">
                                                @csrf
                                                <button type="submit" class="btn btn-success Aprovedbtn">Approve</button>
                                            </form>
                                        @else
                                            Approved
                                        @endif
